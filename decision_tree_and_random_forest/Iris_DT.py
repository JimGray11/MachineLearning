...
# 花萼长度、花萼宽度，花瓣长度，花瓣宽度
# 在没有任何符号的情况下，默认为tuple
iris_feature = 'sepal length', 'sepal width', 'petal length', 'petal width'

if __name__ == "__main__":
    path = u'./dataset/iris/4.iris.data'  # 数据文件路径
    ...
    clf = DecisionTreeClassifier(criterion='entropy', max_depth=40, min_samples_leaf=3)
    dt_clf = clf.fit(x, y)
    ...
    # y.reshape(-1) ------表示将其转换为 1 行n列的方式 [[1,2,3,4,5,6,8]]
